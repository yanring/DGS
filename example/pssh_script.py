...
if __name__ == '__main__':
    ...
    if args.where == '522':
        ...
        command = '/home/yan/anaconda3/envs/an4/bin/python /share/distbelief/deepspeech/train.py --cuda --epoch 100 --lr 4e-4 --weight-decay 1.3e-5 --learning-anneal 1.01 --momentum 0.6 --num-workers 4 --augment --batch-size 5 --world-size ' + str(
            len(hosts)) + ' --cuda %s'
    else:
